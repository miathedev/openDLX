...
public class BranchTargetBuffer
{
	...
	private void initialize() throws BranchPredictionException
	{
		...
		log.info("Initialising the predictors with: " + predictor_initial_state);
		...
		for(int i = 0; i < btb_size; i++)
		{
			...
			case S_BACKWARD_TAKEN:
				log.error("Branch predictor S_BACKWARD_TAKEN currently not implemented.");
			...
			case D_2BIT_HYSTERESIS:
				...
				break;
			default:
				log.error("Unsupported type of branch predictor.");
			}
		}
	}

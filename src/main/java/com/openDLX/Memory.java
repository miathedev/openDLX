...
import java.util.Queue;
 ...
 import com.openDLX.exception.MemoryStageException;
	...
	public MemoryOutputData doCycle() throws MemoryStageException, MemoryException
	{
		...
		if (inst.getLoad())
		{
			if(dmem.getRequestDelay(RequestType.DATA_RD, alu_outLO)==0)
			{
				...
				case BYTE:
					...
					log.debug("PC: " + pc.getValueAsHexString() + " load from addr: " + alu_outLO.getValueAsHexString() + " value: " + ld_result.getValueAsHexString());
					break;
				case UBYTE:
				...
				case UWORD:
					...
					break;
				default:
					log.error("wrong memory width: " + inst.getMemoryWidth()); 
		...
		else if (inst.getStore())
		{
			if(dmem.getRequestDelay(RequestType.DATA_WR, alu_outLO)==0)
			{
				...
				{
				case BYTE:
					log.debug("PC: " + pc.getValueAsHexString() + " store value: " + store_value.getValueAsHexString() + " to addr: " + alu_outLO.getValueAsHexString());
				...
				case WORD_RIGHT_PART:
					...
					case 0:
						...
						log.warn("Verify operation of SWR (0)!");
						if(throwExceptionForUntestedAccesses)
						{
					...
					case 1:
						...
						log.warn("Verify operation of SWR (1)!");
						if(throwExceptionForUntestedAccesses)
						{
					...
					case 2:
						...
						log.warn("Verify operation of SWR (3)!");
						if(throwExceptionForUntestedAccesses)
						{
				...
				case WORD_LEFT_PART:
					...
					case 0:
						...
						log.warn("Verify operation of SWL (0)!");
						if(throwExceptionForUntestedAccesses)
						{
							throw new MemoryStageException("Verify operation of SWR (0)!");
						}
					...
					case 1:
						...
						log.warn("Verify operation of SWL (1)!");
						if(throwExceptionForUntestedAccesses)
						{
							throw new MemoryStageException("Verify operation of SWR (1)!");
						}
					...
					case 2:
						...
						log.warn("Verify operation of SWL (2)!");
						if(throwExceptionForUntestedAccesses)
						{
							throw new MemoryStageException("Verify operation of SWR (2)!");
						}
					...
					case 3:
						...
						log.warn("Verify operation of SWL (3)!");
						if(throwExceptionForUntestedAccesses)
						{
							throw new MemoryStageException("Verify operation of SWR (2)!");
						}
		...
		{
			log.debug("PC: " + pc.getValueAsHexString() + " nothing to do");
		}

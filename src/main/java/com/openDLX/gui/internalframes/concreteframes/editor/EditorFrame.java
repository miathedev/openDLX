 ...
 ******************************************************************************/
package com.openDLX.gui.internalframes.concreteframes.editor;
...
import javax.swing.undo.*;
 ...
 import com.openDLX.gui.command.userLevel.CommandClearEditor;
 ...
 import com.openDLX.gui.command.userLevel.CommandRunFromEditor;
 import com.openDLX.gui.command.userLevel.CommandSave;
 import com.openDLX.gui.internalframes.FrameConfiguration;
...
//        EventCommandLookUp.put(redo, redoCommand);
    ...
    private JButton createButton(String name, String tooltip, int mnemonic, String icon_path) 
    {
        ...
        if(icon_path != null)
        {
            final ImageIcon icon = new ImageIcon(root.toString() + icon_path);
            button.setIcon(icon);

...
import java.util.Queue;
 ...
 import com.openDLX.branchPrediction.BranchTargetBuffer;
 ...
 import com.openDLX.datatypes.BranchPredictorType;
 import com.openDLX.datatypes.BranchTargetBufferLookupResult;
...
public class BranchPredictionModule
{
	...
	public BranchPredictionModuleOutputData lookupTables()
	{
		...
		{
			log.debug("instruction at: " + pc.getValueAsHexString() + " found in BTB and is predicted as " + ((do_speculative_jump)?("taken to addr: " + branch_tgt.getValueAsHexString()):("not taken")));
		}
		else if(result == BranchTargetBufferLookupResult.MISS)
		{
			log.debug("instruction at: " + pc.getValueAsHexString() + " was not found in BTB");
		}
